...
export const getAttributeInfo = (_req: Request, res: Response) => {
  res.json({
    ...
    flavorNotes:
      'Вкусовые ноты описывают характерные оттенки вкуса и аромата кофе — от фруктовых и ягодных до шоколадных и ореховых. Формируются сочетанием терруара, обработки зерна и обжарки.',
  });
};
